    ...
    return (
        <section className='py-20 my-container bg-[#252734]  ' id='project'  >
            ...
            <section className='my-10 grid grid-cols-1 lg:grid-cols-3 gap-5' >
                {
                    projects.map((project, index) => <div key={index} className="max-w-xl bg-[#182234]  rounded-xl shadow-xl" data-aos="fade-right" data-aos-duration="1000">
                        ...
                        <div className="items-center text-center px-2 my-2">
                            ...
                            <div className='flex justify-center gap-5 my-5'>
                                <label  htmlFor="my_modal_6" onClick={() =>handleProject(project)} className="border border-sky-700 px-6 py-3 cursor-pointer  text-sm text-white rounded-lg font-semibold uppercase tracking-wide hover:bg-sky-800">
                                    View Details
                                </label>
                                <button >
                                    <a target="_blank" href={project.liveSite} rel='noreferrer' role="button" className="border border-sky-700 bg-sky-700 px-6 py-3 text-sm text-white rounded-lg font-semibold uppercase tracking-wide hover:bg-sky-800">Visit Live Project</a>
                                </button>
                            </div>
